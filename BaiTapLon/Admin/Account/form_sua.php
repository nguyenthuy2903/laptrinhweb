...
<body class="">
  <?php include("../layout/left.php") ?>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Quản lý chung</a>
          </div>
    ...
    if(isset($_GET['error']))
    {
      echo "<p style='display:none;'>".$_GET['error']."</p>";
    }

?>
     <!-- <form action="xladd.php" method="POST">-->
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Hoàn thành tài khoản của bạn</p>
                </div>
                <div class="card-body">
                  <form action="xladd.php" method="POST">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">usename</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <label for="myfile">Hãy chọn ảnh của bạn:</label>
                        <a><input type="file" id="myfile" name="myfile"><br><br></a>
                      </div>
                    </div>
