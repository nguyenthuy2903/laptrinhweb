...
<body class="">
  <?php include("../layout/left.php") ?>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Danh mục tài khoản</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Danh mục tài khoản</h4>
    ...
    ?>
      ...
      <tr>
        ...
        <td> <a type="button" class="btn btn-info" href="../example/user.php?ID=<?php echo $row['ID'];?>">Sửa</a>
  ...
  <a type="button" class="btn btn-danger" href="../Account/frm_them.php?">Thêm</a>
