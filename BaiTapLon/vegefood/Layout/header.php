	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sản phẩm</a>
                ...
                <a class="dropdown-item" href=""> Rau củ
                	
                </a>
                
                </div>
	         
	             <li class="nav-item"><a href="checkout.php" class="nav-link">Thanh toán</a></li>
	             <!-- <li class="nav-item"><a href="contact.php" class="nav-link">Contact</a></li>-->
	              <li class="nav-item cta cta-colored"><a href="cart.php" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
	             <li class="nav-item active"><a href="admin/List_Category.php" class="nav-link">Admin</a></li>
